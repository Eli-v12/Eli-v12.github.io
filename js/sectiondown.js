...
function allclicks(x) {
  ...
  x.click(function () {
    ...
    if (x1 === "rgb(255, 255, 255)") {
      x1 = 1;
      $(".chebox").css({
        background: "url('images/checkbox.png') no-repeat 3px 4px #f5c26b",
        "border-color": "#f5c26b",
...
function jian(x) {
  x.click(function () {
    ...
    if (ind != "1") {
      ...
      var resp = parseInt(un.replace(/[^0-9]/gi, ""));
      ind = ind * 1 - 1;
      x.next().text(ind);
      inde = inde * 1 - 1;
...
div.css({
  ...
  height: "44px",
  "padding-top": "50px",
  "border-bottom": "3px solid #ece4d9",
  "font-size": "14px",
  color: "#c2c4c6",
});
...
while (a < shops.length) {
  ...
  trian.css({
    ...
    "border-bottom": "14px solid #b39472",
  });
...
$(".remo").hover(
  function () {
    $(this).css({
      background: "url('images/all1-1.png') no-repeat left",
      "background-size": "30%",
    });
  },
  function () {
...
$(".remo1").hover(
  function () {
    $(this).css({
      background: "url('images/all2-2.png') no-repeat left",
      "background-size": "15%",
    });
  },
  function () {
...
$(".removeclass").click(function () {
  ...
  if (sh == 0) {
    $(".sectiondown").css(
      "background",
      "url('images/g-gwc-k.jpg') no-repeat center #fff"
    );
